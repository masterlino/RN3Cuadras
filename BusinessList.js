...
export default class BusinessList extends Component<Props> {
    ...
    async loadPreferences(){
        ...
        if (this.mDistance == null || this.mResultsLimit == null ||this.mCheapS == null ||this.mAverageS == null ||this.mExpensiveS == null ||this.mVeryExpensiveS == null){
